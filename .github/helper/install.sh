...
bench get-app erpnext https://github.com/frappe/erpnext --branch "${BRANCH_NAME}" --resolve-deps --skip-assets --overwrite
bench get-app hrms https://github.com/frappe/hrms --branch "${BRANCH_NAME}" --resolve-deps --skip-assets --overwrite
